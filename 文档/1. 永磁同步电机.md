...
三相电机的等效电路如下图所示 。
$R_a$ 、 $R_b$ 、 $R_c$ 分别为每相的等效电阻 , 
$L_a$ 、 $L_b$ 、 $L_c$ 分别为每相的等效电感 。 
...
$u_\alpha T=|u_4|T_4+\cfrac{1}{2}|u_6|T_6$


β 轴：

$u_\beta T=\cfrac{\sqrt3}{2}|u_6|T_6$
...
<img width="737" height="194" alt="image" src="https://github.com/user-attachments/assets/c0798cbe-c994-46b8-bca7-c5b81b341c67" />


$V^*_i(t)$  就是 Clark 反变换得到的三相电压 ,  

$V_{max}$  和  $V_{min}$  是三相电压的最大值和最小值 , 实现原理如下图所示 。 
